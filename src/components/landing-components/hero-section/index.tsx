      ...
      <div className="mx-auto max-w-full text-center">
        ...
        >
          ...
          >
            ...
            <span className="md:mx-1"></span> thoughts from{' '}
            <span className="md:mx-[2px]"></span> anywhere
          </motion.h1>
          <motion.p
            variants={FADE_DOWN_ANIMATION_VARIANTS}
          ...
          >
            ...
            {!signedIn ? (
              ...
              <Link href="/ios" className="z-50">
                <Button variant="secondary" className="gap-2">
                  <Image
                    alt="siri"
                    src="https://sirigpt.dhr.wtf/siri.svg"
                    width={20}
                    height={20}
                  />{' '}
            ...
            <Link href="https://github.com/dhravya/dump.place" className="z-50">
              <Button variant="outline" className="bg-transparent flex gap-2">
